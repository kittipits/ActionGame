...
{
    public class BlockItemLife: BlockObject
    {

        public BlockItemLife(PlayScene playScene, float x, float y) : base(playScene)
        {
            this.x = x;
            this.y = y;
        ...
        public override void OnCollision(GameObject other)
        {
            if (other is Player)
            {
                ...
                { 
                    playScene.gameObjects.Add(new ItemLifeBoost(playScene, x, y - 32));
