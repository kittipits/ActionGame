...
{
    public class PlayerSwordComboSecond : PlayerSword
    {
        ...
        public PlayerSwordComboSecond(PlayScene playScene, float x, float y, Direction direction) : base(playScene)
        {
            this.x = x;
            this.y = y;
